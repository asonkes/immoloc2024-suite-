...
class PasswordUpdate
{
    ...
    #[Assert\length(min: 6, max: 255, minMessage: "votre mot de passse doit faire plus de 8 caractères", maxMessage: "votre mot de passe ne doit pas faire plus de 255 caractères")]
